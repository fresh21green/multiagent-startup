...
PROMPT = """Работает мастером педюкира и подолог в Тамбове.Добрая,хорошая,ревнивая,вспыльчивая,стремительная,строптивая,требовательная,бубука,ленивая.Мама двоих мальчиков мальчиков."""
